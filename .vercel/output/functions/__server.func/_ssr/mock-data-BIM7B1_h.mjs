//#region node_modules/.nitro/vite/services/ssr/assets/mock-data-BIM7B1_h.js
var overviewMetrics = [
	{
		label: "Revenue",
		value: "$1.84M",
...
var customerTimeline = [
	{
		channel: "Email",
		action: "Opened 'Velocity Pro 4 restocked'",
		time: "Today · 8:14 AM"
	},
	{
		channel: "Website",
		action: "Viewed product page (3x)",
		time: "Yesterday · 7:48 PM"
	},
	{
		channel: "Mobile App",
		action: "Added 'Trail Socks' to wishlist",
		time: "Yesterday · 6:02 PM"
	},
	{
		channel: "Instagram",
		action: "Engaged with 'Summer Runners' ad",
		time: "Jun 02 · 9:14 AM"
	},
	{
		channel: "Email",
		action: "Subscribed to 'Race Week' newsletter",
		time: "May 29 · 11:20 AM"
	},
	{
		channel: "Website",
		action: "Purchased 'Velocity Pro 3' — $164",
		time: "Apr 18 · 4:33 PM"
	}
];
var channels = [
...
var attributionConflicts = [{
	...
	explanation: "Most of this gap comes from differing attribution windows. Meta uses a 7-day click + 1-day view window and counts cross-device. GA4 uses a 30-day data-driven model but excludes app sessions. Shopify only counts completed orders.",
	...
	explanation: "GA4 is including organic-assisted branded sessions. The 72 conversion delta is almost entirely from users who clicked an ad once, then returned via direct traffic within 7 days.",
...
var successMetrics = [
	{
		...
		value: "$1.84M",
		trend: "+12.4%",
		explain: "Total revenue attributed to tracked journeys this period."
	},
	{
		label: "ROAS",
		value: "4.6x",
		trend: "+0.3",
		explain: "Revenue divided by paid ad spend across Meta and Google."
	},
	{
		label: "Customer Lifetime Value",
		value: "$1,284",
		trend: "+6.8%",
		explain: "Predicted 24-month revenue per active customer."
	},
	{
		label: "Conversion Rate",
		value: "4.62%",
		trend: "+0.38pp",
		explain: "Share of started journeys that ended in a purchase."
	},
	{
		label: "Journey Completion",
		value: "68.1%",
		trend: "+3.2%",
		explain: "Journeys that reached the intended end state without dropoff."
	},
	{
		label: "Cross-Channel Engagement",
		value: "72 / 100",
		trend: "+4",
		explain: "How fluidly customers move between channels in a journey."
	},
	{
		label: "Attribution Accuracy",
		value: "88%",
		trend: "+2pp",
		explain: "Confidence the model places on its credit assignment."
	}
];
var metricTrend = [
	{
...
//#endregion
export { customerTimeline as a, journeySteps as c, recentJourneys as d, revenueTrend as f, channels as i, metricTrend as l, attributionConflicts as n, customers as o, successMetrics as p, channelMix as r, journeyInsights as s, aiInsights as t, overviewMetrics as u };
